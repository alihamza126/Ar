...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      icon: <BookOutlined />,
      label: "Borrow Books",
      onClick: () => router.push("/teacher/books"),
    },
    {
      key: "/teacher/suggestions",
      icon: <AppstoreOutlined />,
      label: "Book Suggestions",
      onClick: () => router.push("/teacher/suggestions"),
    },
    {
      key: "/teacher/history",
  ...
  const getPageTitle = () => {
    ...
    return currentItem?.label || "Teacher Dashboard"
  }
  ...
  const sidebarContent = (
    <>
      ...
      >
        {!collapsed && <div style={{ fontSize: "18px", fontWeight: "bold" }}>Teacher Portal</div>}
        {collapsed && (
          <div
            style={{
              width: "100%",
